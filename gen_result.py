...
ce_model_names_per_task = ['outputs/models/FinDER/ce_only_positive_pair',# FinDER
                        'outputs/models/FinQABench/ce_only_positive_pair',# FinQABench
                        'outputs/models/FinanceBench/ce_only_positive_pair',# FinanceBench
                        'outputs/models/TATQA/ce_only_positive_pair',# TATQA
                        'outputs/models/FinQA/ce_only_positive_pair',# FinQA
                        'outputs/models/ConvFinQA/ce_only_positive_pair',# ConvFinQA
                        'outputs/models/MultiHiertt/ce_only_positive_pair' # MultiHiertt
                        ]
                        
# for task, bi_model_name_task, ce_model_name_task in zip(tasks, bi_model_names_per_task, ce_model_names_per_task):
#   if 'MultiHiertt' not in ce_model_name_task:
#     print("skip model")
#     continue
...
#       model_name_or_path="intfloat/e5-small",#bi_model_name_task,
#       # q_model=model,
#       # doc_model=model,
#       query_prompt='query: ',
#       doc_prompt='passage: '
...
#   print("rearanking")
#   reranked_results.append(task.rerank(reranker, results, top_k=20000, batch_size=64, show_progress_bar=True))
