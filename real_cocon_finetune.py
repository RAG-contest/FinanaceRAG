...
def train(dataset_name):
    ...
    model = SentenceTransformerCL(f".models/{dataset_name}/co-condenser-marco")
    ...
    model.fit(
        ...
        output_path=f'.models/{dataset_name}/co-condenser-marco_e15'
    )

    # 12. 모델 저장
    model.save(f'.models/{dataset_name}/co-condenser-marco_e15')
